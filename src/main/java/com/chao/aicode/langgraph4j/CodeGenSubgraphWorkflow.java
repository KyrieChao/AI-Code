package com.chao.aicode.langgraph4j;

import com.chao.aicode.common.response.HTTPResponseCode;
import com.chao.aicode.exception.BusinessException;
import com.chao.aicode.langgraph4j.model.QualityResult;
import com.chao.aicode.langgraph4j.node.*;
import com.chao.aicode.langgraph4j.node.concurrent.*;
import com.chao.aicode.langgraph4j.state.WorkflowContext;
...
public class CodeGenSubgraphWorkflow {
    ...
    private StateGraph<MessagesState<String>> createContentImageSubgraph() {
        try {
            ...
            throw new BusinessException(HTTPResponseCode.OPERATION_FAILED, "内容图片子图创建失败");
        }
    }
    ...
    private StateGraph<MessagesState<String>> createIllustrationSubgraph() {
        try {
            ...
            throw new BusinessException(HTTPResponseCode.OPERATION_FAILED, "插画子图创建失败");
        }
    }
    ...
    private StateGraph<MessagesState<String>> createDiagramSubgraph() {
        try {
            ...
            throw new BusinessException(HTTPResponseCode.OPERATION_FAILED, "架构图子图创建失败");
        }
    }
    ...
    private StateGraph<MessagesState<String>> createLogoSubgraph() {
        try {
            ...
            throw new BusinessException(HTTPResponseCode.OPERATION_FAILED, "Logo子图创建失败");
        }
    }
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            ...
            throw new BusinessException(HTTPResponseCode.OPERATION_FAILED, "子图工作流创建失败");
        }
    }
